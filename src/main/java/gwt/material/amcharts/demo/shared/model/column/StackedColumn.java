...
public class StackedColumn extends ChartData {

    public StackedColumn() {
        super("#stacked-column-chart", "Stacked Column Chart", "Our Serial chart can stack any graphs of the same kind – columns, bars, lines, step lines. They can be stacked in a regular way or 100%, when values are recalculated to percent values.");
